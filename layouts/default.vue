...
<template>
  ...
  >
    ...
    >
      <NavbarItem
        class="hidden md:flex lg:flex md:sticky lg:sticky md:top-0 lg:top-0 z-10"
      ></NavbarItem>
      <div class="px-5 py-5 md:px-10 lg:px-10 md:pb-5 lg:pb-5">
        <slot />
      </div>
    </div>
    <NavbarItem
      class="fixed bottom-0 left-0 w-full md:hidden lg:hidden z-10"
    ></NavbarItem>
  </main>
</template>
