<template>
  ...
  >
    <button
      @click="expand()"
      class="px-3 py-1.5 absolute top-0 right-0 md:hidden lg:hidden border-0 rounded-md box-shadow bg-[#f6f6f6] dark:bg-dark-inner-color flex justify-center items-center text-center z-20"
    >
      <span class="text-secondary-color">v</span>
    </button>
    <div class="px-7 py-4 md:py-10 lg:py-10">
      ...
      >
        <div
          class="w-1/3 md:w-full lg:w-full img p-3 md:m-2 lg:m-2 drop-shadow-xl bg-inner-color dark:bg-dark-inner-color rounded-3xl"
        >
        ...
        >
          ...
          <div class="status flex justify-center">
            <h2
              class="bg-[#f6f6f6] dark:bg-dark-inner-color inline px-3 py-1 rounded-lg mt-2 mb-1 drop-shadow-sm font-semibold text-md"
            >
              Software Engineer
            </h2>
          </div>
